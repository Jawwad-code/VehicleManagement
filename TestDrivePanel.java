...
class TestDrivePanel extends JPanel {
    ...
    public TestDrivePanel() {
        try {
            ...
            ex.printStackTrace();
            JOptionPane.showMessageDialog(this, "Error initializing TestDrivePanel:\n" + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
                ...
                try {
                    ...
                    testBtn.addActionListener(e -> {
                        try {
                            ...
                            ex.printStackTrace();
                            JOptionPane.showMessageDialog(this, "Error during test drive:\n" + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
                        }
                    });
    ...
    public static void main(String[] args) {
        try {
            ...
            ex.printStackTrace();
            JOptionPane.showMessageDialog(null, "Error starting TestDrivePanel:\n" + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
}
